...
public class ZookeeperIpList {
    ...
    public void init(String zkServerAddr, String zkGroup, String dataId, String serviceGroup) {
        ...
        this.dataId = "/" + zkGroup + "/" + temp[0] + "/providers";     // 拼接订阅路径
        String consumeUrl = "consumer://127.0.0.1/?group=" + serviceGroup + "&interface=" + temp[0] + "&version=" + temp[1];
        ...
        List<String> list = zkClient.subscribeChildChanges(this.dataId, (parentPath, currentChilds) -> {
            // 3.1解析服务提供者地址列表
